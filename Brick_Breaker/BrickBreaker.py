...
class Brick(PlayComponent):
    colorArray = {1: 'firebrick1', 2: 'firebrick3', 3:'firebrick4'}
...
class Game(tk.Frame):
    def __init__(self, master):
        ...
        for x in range(100, self.width - 100, 60):
            self.display_brick(x+20,50,3)
            self.display_brick(x+20,70,2)
            self.display_brick(x+20,110,1)
            self.display_brick(x+20,130,1)
    ...
    def game_loop(self):
        ...
        if num_bricks == 0:
            ...
            self.draw_text(self.width/2, self.height/2, "You Won!")
